        ...
        <table>
        	...
        	<tr>
        		...
        		<td id="not_title" onmouseover="underline(this)" onmouseout="underlineDelete(this)">
        			<a href="../noticeController/NoticeViewAction.do?num=<%=notice.getNum()%>&pageNum=<%=pageNum%>"><%=notice.getTitle()%></a>
        		</td>
        ...
        <div id="page_number">
        	<div align="center">
        		...
        		<c:forEach var="i" begin="1" end="<%=total_page%>"> <!-- 반복문 -->
        			<a href="<c:url value='../noticeController/NoticeListAction.do?pageNum=${i}'/>">
        				<c:choose>
        	...
        	<% if(sessionId.equals("admin")) { %>
        		<button style="height: 40px;" onclick="location.href='../noticeController/NoticeWriteForm.do?id=<%=sessionId%>'">글쓰기</button>
        	<% } %>
        	</div>
        	<form action="<c:url value='../noticeController/NoticeListAction.do'/>" method="post" enctype="UTF-8">
		        <div id="search_box">
