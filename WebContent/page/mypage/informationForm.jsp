...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/information.css'/>">
    <script src="<c:url value='/resources/js/info_update_check.js'/>" charset="UTF-8"></script>
